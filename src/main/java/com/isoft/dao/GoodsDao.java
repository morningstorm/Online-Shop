...
//    分页查询所有商品
    List<TbGoods> selectgoods(@Param("offset") Integer offset, @Param("size") Integer size,
                              @Param("gname") String gname, @Param("order") String order, @Param("orderSort") String orderSort,
                              @Param("gstatus") Integer gstatus, @Param("typeId") Integer typeId
    );
//    行数
    int GoodsTotal(@Param("gname") String gname, @Param("gstatus") Integer gstatus, @Param("typeId") Integer typeId);
//    修改商品状态
